...
function getChartData(tbal, old = null) {
	...
	return {
		...
		datasets: [
			...
			// {
			// 	label: 'EMA',
			// 	data: getEMA(data.lasts, GL.WEIGHTED_AVG_PERIODS),
			// 	tension: 0.1,
			// 	borderWidth: 1,
			// 	pointRadius: 0,
			// 	pointHoverRadius: 0,
			...
			// 	//hidden: (old === null || typeof old.datasets[3] === 'undefined' ) ? false : old.datasets[3].hidden,
			// },
			// {
			// 	label: 'SMA',
			// 	data: getSMA(data.lasts, GL.WEIGHTED_AVG_PERIODS),
			// 	tension: 0.1,
			// 	borderWidth: 1,
			// 	pointRadius: 0,
			// 	pointHoverRadius: 0,
